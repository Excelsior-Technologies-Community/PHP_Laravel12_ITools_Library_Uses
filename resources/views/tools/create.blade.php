    ...
    <div class="max-w-3xl mx-auto py-8">
        ...
        <form action="{{ route('tools.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="w-full border rounded px-3 py-2 mt-1"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="5" class="w-full border rounded px-3 py-2 mt-1"
